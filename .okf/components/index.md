...
* [Proxy standalone (agentspy_proxy.py)](standalone-proxy.md) - Prototipo originale self-contained — solo proxy trasparente con log JSONL su file; precursore di server/proxy.py.
